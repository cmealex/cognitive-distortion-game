...
function selectAvatar(event) {
    ...
    currentProfile.avatar = event.target.getAttribute('data-avatar');
}
...
function updateProfileDisplay() {
    ...
    document.getElementById('profile-avatar').src = `/api/placeholder/50/50`;
    document.getElementById('profile-avatar').setAttribute('data-avatar', currentProfile.avatar);
}
